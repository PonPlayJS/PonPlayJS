...
Soy un **desarrollador autodidacta y entusiasta de la robótica** desde Chile 🇨🇱.  
Actualmente tengo **17 años** y el próximo año comenzaré la carrera de **Ingeniería en Telecomunicaciones** 📡.
...
- **Lenguajes:** Python y explorando
- **Áreas de interés:** Machine Learning, Visión por Computador, Robótica, Telecomunicaciones.
- **Herramientas:** Git, Jupyter, ROS (iniciando), Linux, VS Code.
